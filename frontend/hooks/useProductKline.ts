...
export function useProductKline(
  ...
  const [selectedKlineSource, setSelectedKlineSource] = useState<KlineSource>('main')
  const [displayedKlineSource, setDisplayedKlineSource] = useState<KlineSource>('main')
