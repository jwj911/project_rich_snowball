...
function _mapVarietyToProduct(v: Record<string, unknown>): Product {
  return {
    ...
    close_price: (v.close_price as number | null) ?? null,
    settle: (v.settle as number | null) ?? null,
    ...
    oi_chg: (v.oi_chg as number | null) ?? null,
    ...
    trade_date: (v.trade_date as string | null) ?? null,
